...
namespace TradeO.DataAccess.Migrations
{
    ...
    [Migration("20251018223953_InitPostgres")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TradeO.Models.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TradeO.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TradeO.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TradeO.Models.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TradeO.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TradeO.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("TradeO.Models.OrderDetail", b =>
                {
                    b.HasOne("TradeO.Models.OrderHeader", "OrderHeader")
                        .WithMany()
                        .HasForeignKey("OrderHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TradeO.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("TradeO.Models.OrderHeader", b =>
                {
                    b.HasOne("TradeO.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("TradeO.Models.Product", b =>
                {
                    b.HasOne("TradeO.Models.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("TradeO.Models.ApplicationUser", b =>
                {
                    b.HasOne("TradeO.Models.Company", "Company")
                        .WithMany()
